...
export default function BgRemoverPopUp({
  baseImageWithBg,
  savedMask,
  setBaseImage,
  setSavedMask,
  ...
  const [stashedBgRemovedImage, loadStashedBgRemovedImage] = useState<
    string | null
  >(null); // store to return to user upon saving/reversion
